...
def generate(text, prefer_horizontal=0.6, back_color="black", font="Marvind"):
    ...
    #creates word cloud    
    wc = WordCloud(width=1920, height=1080, prefer_horizontal=prefer_horizontal, background_color=back_color, font_path="../res/fonts/"+font+".ttf").generate_from_frequencies(text)
