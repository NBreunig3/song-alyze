...
def generate(text, prefer_horizontal=0.6, back_color="white"):
    wc = WordCloud(width=1920, height=1080, prefer_horizontal=prefer_horizontal, background_color=back_color, font_path="../res/fonts/Marvind.ttf").generate(text)
