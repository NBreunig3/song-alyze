...
# TODO: Add more methods using spotipy below
...
def main():
    ...
    AUTH_TOKEN = spotipy.prompt_for_user_token(username="", scope=SPOTIFY_SCOPES, client_id=spotify_ids["client_id"],
    ...
    # Call our functions that use spotipy
    print(get_top_tracks(limit=10, time_range="short_term"))
    print(get_top_artists(limit=10, time_range="short_term"))
